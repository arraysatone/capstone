...
<html>
    ...
    <body>
    	...
    	<div class="row">
            <div class="col-lg-12">
              <p>
                <button type="button" class="newBtn newBtn-sq-nm bdrWhite" onclick=" window.location = 'cabinet.html'">
            	...
            	<button type="button" class="newBtn newBtn-sq-nm bdrRed" onclick=" window.location = 'cabinet.html'">
                    <div class="newBtnTitle">
                ...
                <button type="button" class="newBtn newBtn-sq-nm bdrWhite" onclick=" window.location = 'cabinet.html'">
                    <div class="newBtnTitle">
                       <span class="newBtnTitleText">Cabinet 5</span>
                    </div>
                    <hr>
                    <div class="newBtnDisplay">
                        <p class="newBtnDisplayText colorSafe" id="cab2Temp">22&deg</p>
                ...
                <button type="button" class="newBtn newBtn-sq-nm bdrWhite" onclick=" window.location = 'cabinet.html'">
                    <div class="newBtnTitle">
                       <span class="newBtnTitleText">Cabinet 6</span>
                    </div>
                    <hr>
                    <div class="newBtnDisplay">
                        <p class="newBtnDisplayText colorSafe" id="cab2Temp">22&deg</p>
                ...
                <button type="button" class="newBtn newBtn-sq-nm bdrWhite" onclick=" window.location = 'cabinet.html'">
                    <div class="newBtnTitle">
                       <span class="newBtnTitleText">Cabinet 7</span>
                    </div>
                    <hr>
                    <div class="newBtnDisplay">
                        <p class="newBtnDisplayText colorSafe" id="cab2Temp">22&deg</p>
                ...
                <button type="button" class="newBtn newBtn-sq-nm bdrWhite" onclick=" window.location = 'cabinet.html'">
                    <div class="newBtnTitle">
                       <span class="newBtnTitleText">Cabinet 8</span>
                    </div>
                    <hr>
                    <div class="newBtnDisplay">
                        <p class="newBtnDisplayText colorSafe" id="cab2Temp">22&deg</p>
